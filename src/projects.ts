 ...
 *
 * Parked after the first version because it was not clear enough, and brought
 * back at her request with a drawing of what to measure on every project.
 */
...
export interface Project {
  ...
  title: string;
  find: string;
  /** A tube is measured round; anything flat is measured across. */
  shape: 'tube' | 'flat';
  /** Centimetres: the way round (or across), and the height. */
  width: number;
  height: number;
  tab: boolean;
  measure: string;
